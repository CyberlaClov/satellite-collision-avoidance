...
class SpaceEnv:
    ...
    def __init__(self, 
                 ...
                 initial_fuel=5.0,
                 max_steps=2000):  # 200/dt = 2000 steps
    ...
    def _check_new_debris(self):
        ...
        # Probability increases linearly from 0.01 at t=Δt to 1 at t=100Δt
        prob_threshold = min(0.01 + 0.99 * (self.time / (100 * self.dt)), 1.0)
    ...
    def _get_observation(self):
        ...
        self.debris_list.sort(key=lambda d: self._get_collision_probability(d), reverse=True)
        ...
        for debris in relevant_debris:
            ...
            obs.extend([relative_pos_x, relative_pos_y, 
                       debris.vel_x, debris.vel_y, collision_prob])
    ...
    def get_reward(self):
        ...
        # Calculate total survival probability (equation 5)
        survival_prob = 1.0
        ...
        return orbit_reward * survival_prob
    ...
    def take_action(self, action):
        ...
        error_std = self.beta * np.abs((self.vel_y + vel_y_prev) / 2)
